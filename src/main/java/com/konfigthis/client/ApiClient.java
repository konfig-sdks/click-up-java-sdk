...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.clickup.com/api/v2";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("Authorization Token", new ApiKeyAuth("header", "Authorization"));
        ...
        if (configuration != null) {
            if (configuration.authorizationToken != null) {
                this.setAuthorizationToken(configuration.authorizationToken);
            }
    ...
    public String getAuthorizationToken() {
        return ((ApiKeyAuth) this.getAuthentication("Authorization Token")).getApiKey();
    }

    public void setAuthorizationToken(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("Authorization Token")).setApiKey(apiKey);
    }

    public void setAuthorizationTokenPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("Authorization Token")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.clickup.com/api/v2)
