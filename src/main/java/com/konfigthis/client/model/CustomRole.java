...
public class CustomRole {
  ...
  public CustomRole id(Integer id) {
  ...
  **/
   ...
   * @return the CustomRole instance itself
   */
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomRole
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomRole.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomRole' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomRole> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomRole.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomRole>() {
           @Override
           ...
           public CustomRole read(JsonReader in) throws IOException {
             ...
             CustomRole instance = thisAdapter.fromJsonTree(jsonObj);
