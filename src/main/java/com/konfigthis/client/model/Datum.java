...
import com.konfigthis.client.model.Interval;
import com.konfigthis.client.model.User13;
...
public class Datum {
  ...
  **/
  ...
  public Datum time(Integer time) {
  ...
  **/
  ...
  public Datum intervals(List<Interval> intervals) {
  ...
  public Datum addIntervalsItem(Interval intervalsItem) {
  ...
  **/
   ...
   * @return the Datum instance itself
   */
  public Datum putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Datum datum = (Datum) o;
    return Objects.equals(this.user, datum.user) &&
        Objects.equals(this.time, datum.time) &&
        Objects.equals(this.intervals, datum.intervals)&&
        Objects.equals(this.additionalProperties, datum.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(user, time, intervals, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Datum.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      User13.validateJsonObject(jsonObj.getAsJsonObject("user"));
      ...
      // validate the required field `intervals` (array)
      for (int i = 0; i < jsonArrayintervals.size(); i++) {
        Interval.validateJsonObject(jsonArrayintervals.get(i).getAsJsonObject());
      };
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Datum>() {
           ...
           public Datum read(JsonReader in) throws IOException {
             ...
             Datum instance = thisAdapter.fromJsonTree(jsonObj);
