...
public class GetUserresponse {
  ...
  public GetUserresponse member(Member7 member) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.member, getUserresponse.member)&&
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetUserresponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetUserresponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
