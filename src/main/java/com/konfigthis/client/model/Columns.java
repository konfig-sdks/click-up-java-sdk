 ...
 */
@ApiModel(description = "Custom Fields added to a view at the Everything level will be added to all tasks in your Workspace. Once Custom Fields are added to one of these views, you cannot move it to another level of the Hierarchy.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Columns {
  ...
  public Columns fields(List<String> fields) {
  ...
  public Columns addFieldsItem(String fieldsItem) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Custom Fields require the `_cf` prefix and must be formatted as a JSON object.")
   ...
   * @return the Columns instance itself
   */
  public Columns putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fields, columns.fields)&&
        Objects.equals(this.additionalProperties, columns.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Columns
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Columns.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Columns.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Columns>() {
           ...
           public Columns read(JsonReader in) throws IOException {
             ...
             Columns instance = thisAdapter.fromJsonTree(jsonObj);
