...
public class UpdateWebhookrequest {
  ...
  public UpdateWebhookrequest endpoint(String endpoint) {
  ...
  **/
  ...
  public UpdateWebhookrequest events(String events) {
  ...
  **/
   ...
   * @return the UpdateWebhookrequest instance itself
   */
  public UpdateWebhookrequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.endpoint, updateWebhookrequest.endpoint) &&
        Objects.equals(this.events, updateWebhookrequest.events) &&
        Objects.equals(this.status, updateWebhookrequest.status)&&
        Objects.equals(this.additionalProperties, updateWebhookrequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(endpoint, events, status, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateWebhookrequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : UpdateWebhookrequest.openapiRequiredFields) {
      ...
      if (!jsonObj.get("events").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateWebhookrequest>() {
           ...
           public UpdateWebhookrequest read(JsonReader in) throws IOException {
             ...
             UpdateWebhookrequest instance = thisAdapter.fromJsonTree(jsonObj);
