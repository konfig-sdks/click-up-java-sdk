...
public class Status {
  ...
  **/
  ...
  public Status orderindex(Integer orderindex) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "custom", required = true, value = "")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, status.status) &&
        ...
        Objects.equals(this.orderindex, status.orderindex) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, color, orderindex, type, additionalProperties);
  }
