...
public class Task9 {
  ...
  public Task9 tags(List<String> tags) {
  ...
  public Task9 addTagsItem(String tagsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "9hxX", required = true, value = "")
  ...
  public Task9 customItemId(Object customItemId) {
  ...
  **/
  ...
  public Task9 status(Status status) {
  ...
  **/
  ...
  public Task9 markdownDescription(String markdownDescription) {
  ...
  **/
  ...
  public Task9 orderindex(String orderindex) {
  ...
  **/
  ...
  public Task9 dateCreated(String dateCreated) {
  ...
  **/
  ...
  public Task9 dateUpdated(String dateUpdated) {
  ...
  **/
  ...
  public Task9 dateClosed(Object dateClosed) {
  ...
  **/
  ...
  public Task9 dateDone(Object dateDone) {
  ...
  **/
  ...
  public Task9 creator(Creator creator) {
  ...
  **/
  ...
  public Task9 assignees(List<String> assignees) {
  ...
  public Task9 addAssigneesItem(String assigneesItem) {
  ...
  **/
  ...
  public Task9 checklists(List<String> checklists) {
  ...
  public Task9 addChecklistsItem(String checklistsItem) {
  ...
  **/
  ...
  public Task9 parent(Object parent) {
  ...
  **/
  ...
  public Task9 priority(Object priority) {
  ...
  **/
  ...
  public Task9 dueDate(Object dueDate) {
  ...
  **/
  ...
  public Task9 startDate(Object startDate) {
  ...
  **/
  ...
  public Task9 timeEstimate(Object timeEstimate) {
  ...
  **/
  ...
  public Task9 timeSpent(Object timeSpent) {
  ...
  **/
  ...
  public Task9 folder(Folder folder) {
  ...
  **/
  ...
  public Task9 space(Space space) {
  ...
  **/
   ...
   * @return the Task9 instance itself
   */
  public Task9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Task9 task9 = (Task9) o;
    return Objects.equals(this.tags, task9.tags) &&
        Objects.equals(this.id, task9.id) &&
        Objects.equals(this.customItemId, task9.customItemId) &&
        Objects.equals(this.name, task9.name) &&
        Objects.equals(this.status, task9.status) &&
        Objects.equals(this.markdownDescription, task9.markdownDescription) &&
        Objects.equals(this.orderindex, task9.orderindex) &&
        Objects.equals(this.dateCreated, task9.dateCreated) &&
        Objects.equals(this.dateUpdated, task9.dateUpdated) &&
        Objects.equals(this.dateClosed, task9.dateClosed) &&
        Objects.equals(this.dateDone, task9.dateDone) &&
        Objects.equals(this.creator, task9.creator) &&
        Objects.equals(this.assignees, task9.assignees) &&
        Objects.equals(this.checklists, task9.checklists) &&
        Objects.equals(this.parent, task9.parent) &&
        Objects.equals(this.priority, task9.priority) &&
        Objects.equals(this.dueDate, task9.dueDate) &&
        Objects.equals(this.startDate, task9.startDate) &&
        Objects.equals(this.timeEstimate, task9.timeEstimate) &&
        Objects.equals(this.timeSpent, task9.timeSpent) &&
        Objects.equals(this.list, task9.list) &&
        Objects.equals(this.folder, task9.folder) &&
        Objects.equals(this.space, task9.space) &&
        Objects.equals(this.url, task9.url)&&
        Objects.equals(this.additionalProperties, task9.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, id, customItemId, name, status, markdownDescription, orderindex, dateCreated, dateUpdated, dateClosed, dateDone, creator, assignees, checklists, parent, priority, dueDate, startDate, timeEstimate, timeSpent, list, folder, space, url, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Task9 {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("custom_item_id");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Task9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Task9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Task9 is not found in the empty JSON string", Task9.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Task9.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Task9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Task9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Task9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Task9.class));

       return (TypeAdapter<T>) new TypeAdapter<Task9>() {
           @Override
           public void write(JsonWriter out, Task9 value) throws IOException {
           ...
           @Override
           public Task9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Task9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Task9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Task9
  * @throws IOException if the JSON string is invalid with respect to Task9
  */
  public static Task9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Task9.class);
  }

 /**
  * Convert an instance of Task9 to an JSON string
  *
  * @return JSON string
  */
