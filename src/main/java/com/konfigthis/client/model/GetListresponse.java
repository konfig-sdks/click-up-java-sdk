...
public class GetListresponse {
  ...
  public GetListresponse id(String id) {
  ...
  **/
  ...
  public GetListresponse name(String name) {
  ...
  **/
  ...
  public GetListresponse orderindex(Integer orderindex) {
  ...
  **/
  ...
  public GetListresponse content(String content) {
  ...
  **/
  ...
  public GetListresponse status(Status5 status) {
  ...
  **/
  ...
  public GetListresponse priority(Priority1 priority) {
  ...
  **/
  ...
  public GetListresponse assignee(Object assignee) {
  ...
  **/
  ...
  public GetListresponse dueDate(String dueDate) {
  ...
  **/
  ...
  public GetListresponse dueDateTime(Boolean dueDateTime) {
  ...
  **/
  ...
  public GetListresponse startDate(Object startDate) {
  ...
  **/
  ...
  public GetListresponse startDateTime(Object startDateTime) {
  ...
  **/
  ...
  public GetListresponse folder(Folder3 folder) {
  ...
  **/
  ...
  public GetListresponse space(Space2 space) {
  ...
  **/
  ...
  public GetListresponse inboundAddress(String inboundAddress) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "add.task.124.ac725f.31518a6a-05bb-4997-92a6-1dcfe2f527ca@tasks.clickup.com", required = true, value = "")
  ...
  public GetListresponse archived(Boolean archived) {
  ...
  **/
  ...
  public GetListresponse overrideStatuses(Boolean overrideStatuses) {
  ...
  **/
  ...
  public GetListresponse statuses(List<Status> statuses) {
  ...
  public GetListresponse addStatusesItem(Status statusesItem) {
  ...
  **/
  ...
  public GetListresponse permissionLevel(String permissionLevel) {
  ...
  **/
   ...
   * @return the GetListresponse instance itself
   */
  public GetListresponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, getListresponse.id) &&
        Objects.equals(this.name, getListresponse.name) &&
        Objects.equals(this.orderindex, getListresponse.orderindex) &&
        Objects.equals(this.content, getListresponse.content) &&
        Objects.equals(this.status, getListresponse.status) &&
        Objects.equals(this.priority, getListresponse.priority) &&
        Objects.equals(this.assignee, getListresponse.assignee) &&
        Objects.equals(this.dueDate, getListresponse.dueDate) &&
        Objects.equals(this.dueDateTime, getListresponse.dueDateTime) &&
        Objects.equals(this.startDate, getListresponse.startDate) &&
        Objects.equals(this.startDateTime, getListresponse.startDateTime) &&
        Objects.equals(this.folder, getListresponse.folder) &&
        Objects.equals(this.space, getListresponse.space) &&
        Objects.equals(this.inboundAddress, getListresponse.inboundAddress) &&
        Objects.equals(this.archived, getListresponse.archived) &&
        Objects.equals(this.overrideStatuses, getListresponse.overrideStatuses) &&
        Objects.equals(this.statuses, getListresponse.statuses) &&
        Objects.equals(this.permissionLevel, getListresponse.permissionLevel)&&
        Objects.equals(this.additionalProperties, getListresponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, orderindex, content, status, priority, assignee, dueDate, dueDateTime, startDate, startDateTime, folder, space, inboundAddress, archived, overrideStatuses, statuses, permissionLevel, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetListresponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetListresponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetListresponse is not found in the empty JSON string", GetListresponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetListresponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetListresponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetListresponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetListresponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetListresponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GetListresponse>() {
           @Override
           public void write(JsonWriter out, GetListresponse value) throws IOException {
           ...
           @Override
           public GetListresponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GetListresponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GetListresponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetListresponse
  * @throws IOException if the JSON string is invalid with respect to GetListresponse
  */
  public static GetListresponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetListresponse.class);
  }

 /**
  * Convert an instance of GetListresponse to an JSON string
  *
  * @return JSON string
  */
