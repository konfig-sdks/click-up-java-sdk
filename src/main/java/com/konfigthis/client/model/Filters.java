...
public class Filters {
  ...
  public static final String SERIALIZED_NAME_SHOW_CLOSED = "show_closed";
  @SerializedName(SERIALIZED_NAME_SHOW_CLOSED)
  private Boolean showClosed;

  public Filters() {
  }

  public Filters op(String op) {
  ...
  **/
  ...
  @ApiModelProperty(example = "AND", required = true, value = "The available operator (`op``) values are `AND`` and `OR``.")
  ...
  public Filters fields(List<String> fields) {
  ...
  public Filters addFieldsItem(String fieldsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "View the list of [fields available](https://clickup.com/api) to filter by.")
  ...
  **/
  ...
  public Filters showClosed(Boolean showClosed) {
  ...
  **/
   ...
   * @return the Filters instance itself
   */
  public Filters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.op, filters.op) &&
        Objects.equals(this.fields, filters.fields) &&
        Objects.equals(this.search, filters.search) &&
        Objects.equals(this.showClosed, filters.showClosed)&&
        Objects.equals(this.additionalProperties, filters.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(op, fields, search, showClosed, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    showClosed: ").append(toIndentedString(showClosed)).append("\n");
  ...
  static {
    ...
    openapiRequiredFields.add("show_closed");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Filters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Filters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Filters.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Filters>() {
           ...
           public Filters read(JsonReader in) throws IOException {
             ...
             Filters instance = thisAdapter.fromJsonTree(jsonObj);
