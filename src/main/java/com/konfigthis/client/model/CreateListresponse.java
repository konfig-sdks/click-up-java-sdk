...
public class CreateListresponse {
  ...
  public CreateListresponse id(String id) {
  ...
  **/
  ...
  public CreateListresponse name(String name) {
  ...
  **/
  ...
  public CreateListresponse orderindex(Integer orderindex) {
  ...
  **/
  ...
  public CreateListresponse content(String content) {
  ...
  **/
  ...
  public CreateListresponse status(Status5 status) {
  ...
  **/
  ...
  public CreateListresponse priority(Priority1 priority) {
  ...
  **/
  ...
  public CreateListresponse assignee(Assignee3 assignee) {
  ...
  **/
  ...
  public CreateListresponse taskCount(Object taskCount) {
  ...
  **/
  ...
  public CreateListresponse dueDate(String dueDate) {
  ...
  **/
  ...
  public CreateListresponse dueDateTime(Boolean dueDateTime) {
  ...
  **/
  ...
  public CreateListresponse startDate(Object startDate) {
  ...
  **/
  ...
  public CreateListresponse startDateTime(Object startDateTime) {
  ...
  **/
  ...
  public CreateListresponse folder(Folder3 folder) {
  ...
  **/
  ...
  public CreateListresponse space(Space2 space) {
  ...
  **/
  ...
  public CreateListresponse statuses(List<Status> statuses) {
  ...
  public CreateListresponse addStatusesItem(Status statusesItem) {
  ...
  **/
  ...
  public CreateListresponse inboundAddress(String inboundAddress) {
  ...
  **/
   ...
   * @return the CreateListresponse instance itself
   */
  public CreateListresponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateListresponse createListresponse = (CreateListresponse) o;
    return Objects.equals(this.id, createListresponse.id) &&
        Objects.equals(this.name, createListresponse.name) &&
        Objects.equals(this.orderindex, createListresponse.orderindex) &&
        Objects.equals(this.content, createListresponse.content) &&
        Objects.equals(this.status, createListresponse.status) &&
        Objects.equals(this.priority, createListresponse.priority) &&
        Objects.equals(this.assignee, createListresponse.assignee) &&
        Objects.equals(this.taskCount, createListresponse.taskCount) &&
        Objects.equals(this.dueDate, createListresponse.dueDate) &&
        Objects.equals(this.dueDateTime, createListresponse.dueDateTime) &&
        Objects.equals(this.startDate, createListresponse.startDate) &&
        Objects.equals(this.startDateTime, createListresponse.startDateTime) &&
        Objects.equals(this.folder, createListresponse.folder) &&
        Objects.equals(this.space, createListresponse.space) &&
        Objects.equals(this.statuses, createListresponse.statuses) &&
        Objects.equals(this.inboundAddress, createListresponse.inboundAddress)&&
        Objects.equals(this.additionalProperties, createListresponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateListresponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateListresponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateListresponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateListresponse is not found in the empty JSON string", CreateListresponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CreateListresponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateListresponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateListresponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateListresponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateListresponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateListresponse>() {
           @Override
           public void write(JsonWriter out, CreateListresponse value) throws IOException {
           ...
           @Override
           public CreateListresponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateListresponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateListresponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateListresponse
  * @throws IOException if the JSON string is invalid with respect to CreateListresponse
  */
  public static CreateListresponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateListresponse.class);
  }

 /**
  * Convert an instance of CreateListresponse to an JSON string
  *
  * @return JSON string
  */
