...
public class Comment2 {
  ...
  **/
  ...
  public Comment2 comment(List<Comment1> comment) {
  ...
  public Comment2 addCommentItem(Comment1 commentItem) {
  ...
  **/
  ...
  public Comment2 commentText(String commentText) {
  ...
  **/
  ...
  public Comment2 user(User2 user) {
  ...
  **/
  ...
  public Comment2 resolved(Boolean resolved) {
  ...
  **/
  ...
  public Comment2 assignee(Object assignee) {
  ...
  **/
  ...
  public Comment2 assignedBy(Object assignedBy) {
  ...
  **/
  ...
  public Comment2 reactions(List<String> reactions) {
  ...
  public Comment2 addReactionsItem(String reactionsItem) {
  ...
  **/
  ...
  public Comment2 date(String date) {
  ...
  **/
   ...
   * @return the Comment2 instance itself
   */
  public Comment2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, comment2.id) &&
        Objects.equals(this.comment, comment2.comment) &&
        Objects.equals(this.commentText, comment2.commentText) &&
        Objects.equals(this.user, comment2.user) &&
        Objects.equals(this.resolved, comment2.resolved) &&
        Objects.equals(this.assignee, comment2.assignee) &&
        Objects.equals(this.assignedBy, comment2.assignedBy) &&
        Objects.equals(this.reactions, comment2.reactions) &&
        Objects.equals(this.date, comment2.date)&&
        Objects.equals(this.additionalProperties, comment2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Comment2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Comment2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Comment2 is not found in the empty JSON string", Comment2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Comment2.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Comment2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Comment2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Comment2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Comment2.class));

       return (TypeAdapter<T>) new TypeAdapter<Comment2>() {
           @Override
           public void write(JsonWriter out, Comment2 value) throws IOException {
           ...
           @Override
           public Comment2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Comment2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Comment2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Comment2
  * @throws IOException if the JSON string is invalid with respect to Comment2
  */
  public static Comment2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Comment2.class);
  }

 /**
  * Convert an instance of Comment2 to an JSON string
  *
  * @return JSON string
  */
