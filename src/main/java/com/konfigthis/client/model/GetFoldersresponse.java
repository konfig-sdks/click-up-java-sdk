...
import com.konfigthis.client.model.Folder5;
...
public class GetFoldersresponse {
  ...
  private Folder5 folders;

  public GetFoldersresponse() {
  }

  public GetFoldersresponse folders(Folder5 folders) {
  ...
  **/
  ...
  public Folder5 getFolders() {
    return folders;
  }


  public void setFolders(Folder5 folders) {
   ...
   * @return the GetFoldersresponse instance itself
   */
  public GetFoldersresponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.folders, getFoldersresponse.folders)&&
        Objects.equals(this.additionalProperties, getFoldersresponse.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetFoldersresponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFoldersresponse is not found in the empty JSON string", GetFoldersresponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GetFoldersresponse.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `folders`
      Folder5.validateJsonObject(jsonObj.getAsJsonObject("folders"));
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetFoldersresponse>() {
           ...
           public GetFoldersresponse read(JsonReader in) throws IOException {
             ...
             GetFoldersresponse instance = thisAdapter.fromJsonTree(jsonObj);
