...
public class User5 {
  ...
  **/
  ...
  public User5 username(Object username) {
  ...
  **/
  ...
  public User5 color(Object color) {
  ...
  **/
  ...
  public User5 profilePicture(Object profilePicture) {
  ...
  **/
  ...
  public User5 initials(String initials) {
  ...
  **/
  ...
  public User5 role(Integer role) {
  ...
  **/
  ...
  public User5 customRole(CustomRole customRole) {
  ...
  **/
  ...
  public User5 lastActive(Object lastActive) {
  ...
  **/
  ...
  public User5 dateJoined(Object dateJoined) {
  ...
  **/
  ...
  public User5 dateInvited(String dateInvited) {
  ...
  **/
   ...
   * @return the User5 instance itself
   */
  public User5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    User5 user5 = (User5) o;
    return Objects.equals(this.id, user5.id) &&
        Objects.equals(this.username, user5.username) &&
        Objects.equals(this.email, user5.email) &&
        Objects.equals(this.color, user5.color) &&
        Objects.equals(this.profilePicture, user5.profilePicture) &&
        Objects.equals(this.initials, user5.initials) &&
        Objects.equals(this.role, user5.role) &&
        Objects.equals(this.customRole, user5.customRole) &&
        Objects.equals(this.lastActive, user5.lastActive) &&
        Objects.equals(this.dateJoined, user5.dateJoined) &&
        Objects.equals(this.dateInvited, user5.dateInvited)&&
        Objects.equals(this.additionalProperties, user5.additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("custom_role");
  ...
  * @throws IOException if the JSON Object is invalid with respect to User5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!User5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in User5 is not found in the empty JSON string", User5.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : User5.openapiRequiredFields) {
      ...
      // validate the required field `custom_role`
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!User5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'User5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<User5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(User5.class));

       return (TypeAdapter<T>) new TypeAdapter<User5>() {
           @Override
           public void write(JsonWriter out, User5 value) throws IOException {
           ...
           @Override
           public User5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             User5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of User5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of User5
  * @throws IOException if the JSON string is invalid with respect to User5
  */
  public static User5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, User5.class);
  }

 /**
  * Convert an instance of User5 to an JSON string
  *
  * @return JSON string
  */
