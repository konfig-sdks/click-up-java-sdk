...
public class Folder4 {
  ...
  **/
  ...
  public Folder4 name(String name) {
  ...
  **/
  ...
  public Folder4 orderindex(Integer orderindex) {
  ...
  **/
  ...
  public Folder4 overrideStatuses(Boolean overrideStatuses) {
  ...
  **/
  ...
  public Folder4 hidden(Boolean hidden) {
  ...
  **/
  ...
  public Folder4 taskCount(String taskCount) {
  ...
  **/
  ...
  public Folder4 archived(Boolean archived) {
  ...
  **/
  ...
  public Folder4 statuses(List<Status> statuses) {
  ...
  public Folder4 addStatusesItem(Status statusesItem) {
  ...
  **/
  ...
  public Folder4 lists(List<String> lists) {
  ...
  public Folder4 addListsItem(String listsItem) {
  ...
  **/
  ...
  public Folder4 permissionLevel(String permissionLevel) {
  ...
  **/
   ...
   * @return the Folder4 instance itself
   */
  public Folder4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Folder4 folder4 = (Folder4) o;
    return Objects.equals(this.id, folder4.id) &&
        Objects.equals(this.name, folder4.name) &&
        Objects.equals(this.orderindex, folder4.orderindex) &&
        Objects.equals(this.overrideStatuses, folder4.overrideStatuses) &&
        Objects.equals(this.hidden, folder4.hidden) &&
        Objects.equals(this.taskCount, folder4.taskCount) &&
        Objects.equals(this.archived, folder4.archived) &&
        Objects.equals(this.statuses, folder4.statuses) &&
        Objects.equals(this.lists, folder4.lists) &&
        Objects.equals(this.permissionLevel, folder4.permissionLevel)&&
        Objects.equals(this.additionalProperties, folder4.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, orderindex, overrideStatuses, hidden, taskCount, archived, statuses, lists, permissionLevel, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Folder4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Folder4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Folder4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Folder4 is not found in the empty JSON string", Folder4.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Folder4.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Folder4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Folder4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Folder4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Folder4.class));

       return (TypeAdapter<T>) new TypeAdapter<Folder4>() {
           @Override
           public void write(JsonWriter out, Folder4 value) throws IOException {
           ...
           @Override
           public Folder4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Folder4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Folder4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Folder4
  * @throws IOException if the JSON string is invalid with respect to Folder4
  */
  public static Folder4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Folder4.class);
  }

 /**
  * Convert an instance of Folder4 to an JSON string
  *
  * @return JSON string
  */
