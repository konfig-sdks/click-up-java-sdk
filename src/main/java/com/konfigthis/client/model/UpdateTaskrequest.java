...
public class UpdateTaskrequest {
  ...
  **/
  ...
  @ApiModelProperty(example = "Updated Task Content", value = "To clear the task description, include `Description` with `\" \"`.")
  ...
  public UpdateTaskrequest customItemId(Object customItemId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "To convert an item using a custom task type into a task, send `'null'`. \\  \\ To update this task to be a Milestone, send a value of `1`. \\  \\ To use a custom task type, send the custom task type ID as defined in your Workspace, such as `2`.")
  ...
  **/
  ...
  public UpdateTaskrequest status(String status) {
  ...
  **/
  ...
  public UpdateTaskrequest priority(Integer priority) {
  ...
  **/
  ...
  public UpdateTaskrequest dueDate(Integer dueDate) {
  ...
  **/
  ...
  public UpdateTaskrequest dueDateTime(Boolean dueDateTime) {
  ...
  **/
  ...
  public UpdateTaskrequest parent(String parent) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "abc1234", value = "You can move a subtask to another parent task by including `\"parent\"` with a valid `task id`.\\  \\ You cannot convert a subtask to a task by setting `\"parent\"` to `null`.")
  ...
  public UpdateTaskrequest timeEstimate(Integer timeEstimate) {
  ...
  **/
  ...
  public UpdateTaskrequest startDate(Integer startDate) {
  ...
  **/
  ...
  public UpdateTaskrequest startDateTime(Boolean startDateTime) {
  ...
  **/
  ...
  public UpdateTaskrequest assignees(Assignees assignees) {
  ...
  **/
  ...
  public UpdateTaskrequest archived(Boolean archived) {
  ...
  **/
   ...
   * @return the UpdateTaskrequest instance itself
   */
  public UpdateTaskrequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, updateTaskrequest.description) &&
        Objects.equals(this.customItemId, updateTaskrequest.customItemId) &&
        ...
        Objects.equals(this.dueDateTime, updateTaskrequest.dueDateTime) &&
        Objects.equals(this.parent, updateTaskrequest.parent) &&
        Objects.equals(this.timeEstimate, updateTaskrequest.timeEstimate) &&
        Objects.equals(this.startDate, updateTaskrequest.startDate) &&
        Objects.equals(this.startDateTime, updateTaskrequest.startDateTime) &&
        Objects.equals(this.assignees, updateTaskrequest.assignees) &&
        Objects.equals(this.archived, updateTaskrequest.archived)&&
        Objects.equals(this.additionalProperties, updateTaskrequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, customItemId, name, status, priority, dueDate, dueDateTime, parent, timeEstimate, startDate, startDateTime, assignees, archived, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      // validate the optional field `assignees`
      if (jsonObj.get("assignees") != null && !jsonObj.get("assignees").isJsonNull()) {
        Assignees.validateJsonObject(jsonObj.getAsJsonObject("assignees"));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateTaskrequest>() {
           ...
           public UpdateTaskrequest read(JsonReader in) throws IOException {
             ...
             UpdateTaskrequest instance = thisAdapter.fromJsonTree(jsonObj);
