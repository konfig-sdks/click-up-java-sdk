...
public class GetTaskresponse {
  ...
  public GetTaskresponse tags(List<String> tags) {
  ...
  public GetTaskresponse addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public GetTaskresponse description(String description) {
  ...
  **/
  ...
  public GetTaskresponse customId(Object customId) {
  ...
  **/
  ...
  public GetTaskresponse customItemId(Object customItemId) {
  ...
  **/
  ...
  public GetTaskresponse name(String name) {
  ...
  **/
  ...
  public GetTaskresponse textContent(String textContent) {
  ...
  **/
  ...
  public GetTaskresponse status(Status status) {
  ...
  **/
  ...
  public GetTaskresponse orderindex(String orderindex) {
  ...
  **/
  ...
  public GetTaskresponse dateCreated(String dateCreated) {
  ...
  **/
  ...
  public GetTaskresponse dateUpdated(String dateUpdated) {
  ...
  **/
  ...
  public GetTaskresponse dateClosed(Object dateClosed) {
  ...
  **/
  ...
  public GetTaskresponse creator(Creator creator) {
  ...
  **/
  ...
  public GetTaskresponse assignees(List<String> assignees) {
  ...
  public GetTaskresponse addAssigneesItem(String assigneesItem) {
  ...
  **/
  ...
  public GetTaskresponse checklists(List<String> checklists) {
  ...
  public GetTaskresponse addChecklistsItem(String checklistsItem) {
  ...
  **/
  ...
  public GetTaskresponse parent(Object parent) {
  ...
  **/
  ...
  public GetTaskresponse priority(Object priority) {
  ...
  **/
  ...
  public GetTaskresponse dueDate(Object dueDate) {
  ...
  **/
  ...
  public GetTaskresponse startDate(Object startDate) {
  ...
  **/
  ...
  public GetTaskresponse timeEstimate(Object timeEstimate) {
  ...
  **/
  ...
  public GetTaskresponse timeSpent(Object timeSpent) {
  ...
  **/
  ...
  public GetTaskresponse customFields(List<CustomFields8> customFields) {
  ...
  public GetTaskresponse addCustomFieldsItem(CustomFields8 customFieldsItem) {
  ...
  **/
  ...
  public GetTaskresponse list(List list) {
  ...
  **/
  ...
  public GetTaskresponse folder(Folder folder) {
  ...
  **/
  ...
  public GetTaskresponse space(Space space) {
  ...
  **/
  ...
  public GetTaskresponse url(String url) {
  ...
  **/
  ...
  public GetTaskresponse markdownDescription(String markdownDescription) {
  ...
  **/
   ...
   * @return the GetTaskresponse instance itself
   */
  public GetTaskresponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, getTaskresponse.tags) &&
        Objects.equals(this.description, getTaskresponse.description) &&
        Objects.equals(this.id, getTaskresponse.id) &&
        Objects.equals(this.customId, getTaskresponse.customId) &&
        Objects.equals(this.customItemId, getTaskresponse.customItemId) &&
        Objects.equals(this.name, getTaskresponse.name) &&
        Objects.equals(this.textContent, getTaskresponse.textContent) &&
        Objects.equals(this.status, getTaskresponse.status) &&
        Objects.equals(this.orderindex, getTaskresponse.orderindex) &&
        Objects.equals(this.dateCreated, getTaskresponse.dateCreated) &&
        Objects.equals(this.dateUpdated, getTaskresponse.dateUpdated) &&
        Objects.equals(this.dateClosed, getTaskresponse.dateClosed) &&
        Objects.equals(this.creator, getTaskresponse.creator) &&
        Objects.equals(this.assignees, getTaskresponse.assignees) &&
        Objects.equals(this.checklists, getTaskresponse.checklists) &&
        Objects.equals(this.parent, getTaskresponse.parent) &&
        Objects.equals(this.priority, getTaskresponse.priority) &&
        Objects.equals(this.dueDate, getTaskresponse.dueDate) &&
        Objects.equals(this.startDate, getTaskresponse.startDate) &&
        Objects.equals(this.timeEstimate, getTaskresponse.timeEstimate) &&
        Objects.equals(this.timeSpent, getTaskresponse.timeSpent) &&
        Objects.equals(this.customFields, getTaskresponse.customFields) &&
        Objects.equals(this.list, getTaskresponse.list) &&
        Objects.equals(this.folder, getTaskresponse.folder) &&
        Objects.equals(this.space, getTaskresponse.space) &&
        Objects.equals(this.url, getTaskresponse.url) &&
        Objects.equals(this.markdownDescription, getTaskresponse.markdownDescription)&&
        Objects.equals(this.additionalProperties, getTaskresponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tags, description, id, customId, customItemId, name, textContent, status, orderindex, dateCreated, dateUpdated, dateClosed, creator, assignees, checklists, parent, priority, dueDate, startDate, timeEstimate, timeSpent, customFields, list, folder, space, url, markdownDescription, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetTaskresponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetTaskresponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetTaskresponse>() {
           ...
           public GetTaskresponse read(JsonReader in) throws IOException {
             ...
             GetTaskresponse instance = thisAdapter.fromJsonTree(jsonObj);
